...
source = tbl.SinglePhotonSource(
    ...
    p_single=0.85,
    p_double=0.005,
    wavepacket=tbl.Wavepacket(temporal_width=15e-12),
...
detectors = tbl.DetectorArray(
    {0: tbl.SNSPD(efficiency=0.91, dark_count_rate=5.0, jitter=18e-12, channel=0)}
)
twin = tbl.DigitalTwin(source, [loop], detectors, time_bin_width=25e-9)
