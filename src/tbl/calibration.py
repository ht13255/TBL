"""TBL time-tag analysis, parameter estimation, and model comparison."""
...
def coincidence_histogram(
    ...
    *,
    ...
    half_bins = int(np.ceil(max_delay / bin_width))
    centers = np.arange(-half_bins, half_bins + 1, dtype=float) * bin_width
